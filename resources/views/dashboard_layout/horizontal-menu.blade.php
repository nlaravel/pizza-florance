<nav class="header-navbar navbar-expand-lg navbar navbar-with-menu floating-nav navbar-light navbar-shadow">
    ...
    {{--</ul>--}}
    {{--</li>--}}
        <notification   :userid="{{auth()->user()->id}}" :unread="{{auth()->user()->unreadnotifications }}"></notification>
    ...
    <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"> {{ Auth::user()->name }}</span></div>
            ...
            @else
                <span><img class="round" src="{{asset(auth()->user()->image_url)}}" alt="avatar" height="40" width="40"></span>

            @endif
        </a>
    <div class="dropdown-menu dropdown-menu-right">

        <a class="dropdown-item" href="{{ route('profile.index') }}"><i class="feather icon-user"></i>@lang('lang.profile')</a>
