            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                <div class="action-btns d-none">
                    <div class="btn-dropdown mr-1 mb-1">
                        <div class="btn-group dropdown actions-dropodown">
                            <button type="button" class="btn btn-outline-primary waves-effect waves-light" onclick="location.href = '/dashboard/entrees/create'">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                        <tr  v-for="property,index in entrees_all.data">
                            <td></td>
                            ...
                            <td class="product-name">@{{ property.price }}</td>
                    ...
                    <vs-pagination   :total="entrees_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
