...
@endpush
@section('content')
    <calzone-category-index
            :calzone_category='{{ $calzone_category->toJson() }}'
            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                        <tr  v-for="property,index in calzone_category_all.data" :id="property.id">
                            <td></td>
                    ...
                    <vs-pagination   :total="calzone_category_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
