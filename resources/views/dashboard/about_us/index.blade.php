...
@endpush
@section('content')
    <about-index  :about="{{$about_us}}" inline-template>
        <div>
                                ...
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                            <i class="feather icon-info mr-25"></i><span class="d-none d-sm-block">@lang('lang.about_us')</span>
                                        </a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" class="form-control"  v-model="sub_title"  id="sub_title" name="sub_title">
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="upload-photo" >
                                                            ...
                                                            <div class="upload-photo" v-if="!image">
                                                                <div class="con-upload" >
                                                                    <div class="con-img-upload"  >
                                                                        <div class="con-input-upload" style="margin: 20px auto" @click="toggleFileManagerSidebar(true)">
