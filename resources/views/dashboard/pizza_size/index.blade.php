            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                        <tr  v-for="property,index in pizza_size_all.data" :id="property.id">
                            <td></td>
                    ...
                    <vs-pagination   :total="pizza_size_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
