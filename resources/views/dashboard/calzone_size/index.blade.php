...
@section('content')
    <calzone_size-index
            :calzone_size='{{ $calzone_size->toJson() }}'
            inline-template>
            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                        <tr  v-for="property,index in calzone_size_all.data" :id="property.id">
                            <td></td>
                    ...
                    <vs-pagination   :total="calzone_size_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
                        ...
                        <div class="data-items pb-3">
                            <div class="data-fields px-2 mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 data-field-col"   >
                                        <label for="data-name">  Price</label>
