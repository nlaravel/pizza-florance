            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                <div class="action-btns d-none">
                    <div class="btn-dropdown mr-1 mb-1">
                        <div class="btn-group dropdown actions-dropodown">
                            <button type="button" class="btn btn-outline-primary waves-effect waves-light" onclick="location.href = '/dashboard/payment/create'">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                        <tr  v-for="property,index in payment_all.data" :id="property.id">
                            <td></td>
                    ...
                    <vs-pagination   :total="payment_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
