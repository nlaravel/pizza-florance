            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                <div class="action-btns d-none">
                    <div class="btn-dropdown mr-1 mb-1">
                        <div class="btn-group dropdown actions-dropodown">
                            <button type="button" class="btn btn-outline-primary waves-effect waves-light" onclick="location.href = '/dashboard/coupon/create'">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                        <tr  v-for="property,index in coupons_all.data" :id="property.id">
                            <td></td>
                            <td class="product-name">@{{ property.coupon_code }}</td>
                            <td class="product-name">@{{ property.amount_type }}</td>
                            <td class="product-name">@{{ property.status == 1?'Active':'Not Active'  }}</td>
                    ...
                    <vs-pagination   :total="coupons_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
