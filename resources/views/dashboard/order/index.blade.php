            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                ...
                <div class="table-responsive">
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                        <tr  v-for="property,index in orders_all.data" :id="property.id">
                            <td></td>
                            <td class="product-name">@{{ property.first_name }}</td>
                            <td class="product-name">@{{ property.last_name }}</td>
                    ...
                    <vs-pagination   :total="orders_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
