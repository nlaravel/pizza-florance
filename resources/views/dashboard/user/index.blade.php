                ...
                <section id="data-thumb-view" class="data-thumb-view-header">
                    ...
                    <div class="table-responsive">
                        <table class="table data-thumb-view">
                            ...
                            <tbody>
                            <tr  v-for="property,index in users_all.data" :id="property.id">
                                <td></td>
                    ...
                    <vs-pagination   :total="users_all.last_page"  v-model="currentx" @change="onChangePage" ></vs-pagination>
                            ...
                            <div class="data-items pb-3">
                                <div class="data-fields px-2 mt-3">
                                    <div class="row">
                                        ...
                                        <div style="text-align: -webkit-center;margin: auto;">
                                        <img :src="image_url" id="imageShow"  alt=""
                                        style="display: block;height: 130px;width: 130px;margin-bottom: 10px; border-radius: 55%;">
                                        </div>
                                        </div>
                                        </div>
                                        <div class="col-sm-12 data-field-col">
                                        ...
                                        <div class="col-sm-12 data-field-col">
                                            ...
                                            <span v-if="form.error && form.validations.email" style="color: red">@{{ form.validations.email[0] }}</span>
                                        </div>
                                        <div class="col-sm-12 data-field-col">
                                            <label for="data-name">@lang('lang.password')</label>
                                            <input type="text" class="form-control" id="password" v-model="password">
                                            <span v-if="form.error && form.validations.password" style="color: red">@{{ form.validations.password[0] }}</span>
                                        </div>
                                        <div class="col-sm-12 data-field-col">
                                            <vue-dropzone  @vdropzone-error="errorFile"  @vdropzone-success="successFile"  ref="myVueDropzone" id="dropzone" :options="dropzoneOptions">
